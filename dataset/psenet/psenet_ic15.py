...
# ic15_root_dir = '/media/data1/yrq/TESTR/datasets/ship2023/'
...
ic15_root_dir = '/media/data1/yrq/pan_pp.pytorch/ship_frame/'
ic15_train_data_dir = ic15_root_dir + 'train_images/'
ic15_train_gt_dir = ic15_root_dir + \
                    'train_txt/'
...
class PSENET_IC15(data.Dataset):
    def __init__(self,
        ...
        for data_dir  in data_dirs:
            img_names = [
                img_name for img_name in glob.glob(f"{data_dir}/*.jpeg")
            ]
            img_names.extend([
                img_name for img_name in glob.glob(f"{data_dir}/*.jpeg")
            ])
            # img_names.extend([
            #     img_name for img_name in mmcv.utils.scandir(data_dir, '.jpeg')
            # ])
