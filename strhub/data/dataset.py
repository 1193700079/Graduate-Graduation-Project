...
class LmdbDataset(Dataset):
    ...
    def __init__(self, root: str, charset: str, max_label_len: int, min_image_dim: int = 0,
                 ...
                 unlabelled: bool = False, transform: Optional[Callable] = None,transformclip: Optional[Callable] = None):
        self._env = None
        self.root = root
        ...
        self.transformclip = transformclip
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            mae_img = self.transform(img)
            clip_img = self.transformclip(img)    
        return [mae_img,clip_img], label
        # return mae_img,label
