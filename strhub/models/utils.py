...
def _get_model_class(key):
    ...
    elif 'CMFSTR' in key and 'ship' in key:
        from .huiguan_mae_parseq.system_ship import MAE_PARSeq as ModelClass      
    elif 'CMFSTR' in key:
        from .huiguan_mae_parseq.system import MAE_PARSeq as ModelClass     
    elif 'parseq' in key:
