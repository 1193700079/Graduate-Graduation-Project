...
class CLIP(nn.Module):
    ...
    def encode_text(self, text, return_all_tokens=False, return_patch_tokens=True):
    ...
    def encode_text_feature(self, x, return_all_tokens=False, return_patch_tokens=False):
        # x = self.token_embedding(text).type(self.dtype)  # [batch_size, n_ctx, d_model]
