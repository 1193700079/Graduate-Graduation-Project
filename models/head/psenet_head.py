...
class PSENet_Head(nn.Module):
    ...
    def get_results(self, out, img_meta, cfg):
        ...
        score = torch.sigmoid(out[:, 0, :, :]) #1024*1760
        ...
        label = pse(kernels, cfg.test_cfg.min_area) # 1024*1760
        ...
        # print(img_size) #1024*1760 h*w
        # img_size = img_size.cpu().numpy().astype(np.int32)
        # print(label)
        # print(score)
